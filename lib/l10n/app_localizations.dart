...
const Map<String, Map<String, String>> _strings = {
  'es': {
    ...
    'readerFirstTip': 'Lápiz bronce: anotar (Marcado pausa el scroll) · Icono de firma: firmar.',
...
'welcomePage1Title': 'Privacidad de verdad',
  ...
  'en': {
    ...
    'readerFirstTip': 'Bronze pen: annotate (Highlight pauses scroll) · Signature icon: sign.',
...
'welcomePage1Title': 'Real privacy',
  ...
  'pt': {
    ...
    'readerFirstTip': 'Lápis bronze: anotar (Marcado pausa o scroll) · Ícone de assinatura: assinar.',
    'filterEbonyOn': 'Filtro Ébano',
...
'welcomePage1Title': 'Privacidade a sério',
  ...
  'fr': {
    ...
    'readerFirstTip': 'Stylo bronze : annoter (Surligner pause le défilement) · Icône signature : signer.',
...
'welcomePage1Title': 'Une vraie confidentialité',
  ...
  'de': {
    ...
    'readerFirstTip': 'Bronzestift: annotieren (Markieren pausiert Scroll) · Unterschrift-Symbol: unterschreiben.',
    'filterEbonyOn': 'Ébano-Filter',
...
'welcomePage1Title': 'Echte Privatsphäre',
  ...
  'zh': {
    ...
    'readerFirstTip': '铜色笔：批注（高亮会暂停滚动）· 签名图标：签名。',
...
'welcomePage1Title': '真正的隐私',
  ...
  'ru': {
    ...
    'readerFirstTip': 'Бронзовый карандаш: аннотации (выделение останавливает прокрутку) · Иконка подписи: подписать.',
