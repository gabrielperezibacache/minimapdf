...
class AppLocalizations {
  ...
  String get searchTextTool => _t('searchTextTool');
  String get searchTextHint => _t('searchTextHint');
  String get searchTextNoResults => _t('searchTextNoResults');
  String get searchTextSearching => _t('searchTextSearching');
  String searchTextMatchOf(int current, int total) => _t('searchTextMatchOf')
      .replaceAll('{current}', '$current')
      .replaceAll('{total}', '$total');
  String get searchTextPrevious => _t('searchTextPrevious');
  String get searchTextNext => _t('searchTextNext');
...
const Map<String, Map<String, String>> _strings = {
  'es': {
    ...
    'drawingAllowsScrollHint':
        'Candado abierto: un dedo dibuja; solo dos dedos hacen zoom o mueven la página (el scroll de páginas sigue bloqueado).',
    'lockPageNavigation': 'Bloquear zoom con dos dedos',
    ...
    'searchTextTool': 'Buscar texto',
    'searchTextHint': 'Buscar en el documento…',
    'searchTextNoResults': 'Sin resultados',
    'searchTextSearching': 'Buscando…',
    'searchTextMatchOf': '{current} de {total}',
    'searchTextPrevious': 'Anterior',
    'searchTextNext': 'Siguiente',
    'unlockPageNavigation': 'Permitir zoom con dos dedos',
    ...
    'minimizeAnnotationTools': 'Seguir dibujando (minimizar)',
    'readerFirstTip': 'Lápiz: elige Marcado/Subrayado/Chincheta · Candado: zoom a 2 dedos · Firma: firmar.',
    ...
    'noAnnotations':
        'Aún no hay anotaciones.\nPulsa Abrir herramientas: Marcado, Subrayado o Chincheta.',
    'noSignatures':
    ...
    'annotationHintHighlight':
        'Dibuja con un dedo o el S-Pen; el trazo sigue tu movimiento.',
    'annotationHintUnderline':
        'Dibuja bajo el texto con un dedo o el S-Pen.',
...
'welcomePage1Title': 'Privacidad de verdad',
  ...
  'en': {
    ...
    'drawingAllowsScrollHint':
        'Lock open: one finger draws; only two fingers zoom or move the page (page scroll stays locked).',
    'lockPageNavigation': 'Lock two-finger zoom',
    ...
    'searchTextTool': 'Search text',
    'searchTextHint': 'Search in document…',
    'searchTextNoResults': 'No results',
    'searchTextSearching': 'Searching…',
    'searchTextMatchOf': '{current} of {total}',
    'searchTextPrevious': 'Previous',
    'searchTextNext': 'Next',
    'unlockPageNavigation': 'Allow two-finger zoom',
    ...
    'minimizeAnnotationTools': 'Keep drawing (minimize)',
    'readerFirstTip': 'Pen: choose Highlight/Underline/Pin · Lock: two-finger zoom · Signature: sign.',
    ...
    'noAnnotations':
        'No annotations yet.\nTap Open tools: Highlight, Underline, or Pin note.',
    'noSignatures':
    ...
    'annotationHintHighlight':
        'Draw with one finger or S-Pen; the stroke follows your movement.',
    'annotationHintUnderline':
        'Draw under the text with one finger or S-Pen.',
...
'welcomePage1Title': 'Real privacy',
  ...
  'pt': {
    ...
    'drawingAllowsScrollHint':
        'Cadeado aberto: um dedo desenha; só dois dedos fazem zoom ou movem a página (o scroll de páginas continua bloqueado).',
    'lockPageNavigation': 'Bloquear zoom com dois dedos',
    ...
    'searchTextTool': 'Buscar texto',
    'searchTextHint': 'Buscar no documento…',
    'searchTextNoResults': 'Sem resultados',
    'searchTextSearching': 'A procurar…',
    'searchTextMatchOf': '{current} de {total}',
    'searchTextPrevious': 'Anterior',
    'searchTextNext': 'Seguinte',
    'unlockPageNavigation': 'Permitir zoom com dois dedos',
    ...
    'minimizeAnnotationTools': 'Continuar a desenhar (minimizar)',
    'readerFirstTip': 'Lápis: escolha Marcado/Sublinhado/Alfinete · Cadeado: zoom a 2 dedos · Assinatura: assinar.',
    'filterEbonyOn': 'Filtro Ébano',
    ...
    'annotationHintHighlight': 'Desenhe com um dedo ou S-Pen; o traço segue o movimento.',
    'annotationHintUnderline': 'Desenhe sob o texto com um dedo ou S-Pen.',
...
'welcomePage1Title': 'Privacidade a sério',
  ...
  'fr': {
    ...
    'drawingAllowsScrollHint':
        'Cadenas ouvert : un doigt dessine ; seuls deux doigts zoom/déplacent la page (le défilement des pages reste bloqué).',
    'lockPageNavigation': 'Verrouiller le zoom à deux doigts',
    ...
    'searchTextTool': 'Rechercher du texte',
    'searchTextHint': 'Rechercher dans le document…',
    'searchTextNoResults': 'Aucun résultat',
    'searchTextSearching': 'Recherche…',
    'searchTextMatchOf': '{current} sur {total}',
    'searchTextPrevious': 'Précédent',
    'searchTextNext': 'Suivant',
    'unlockPageNavigation': 'Autoriser le zoom à deux doigts',
    ...
    'minimizeAnnotationTools': 'Continuer à dessiner (réduire)',
    'readerFirstTip': 'Stylo : choisissez Surligner/Souligner/Épingle · Cadenas : zoom à 2 doigts · Signature : signer.',
    ...
    'annotationHintHighlight': 'Dessinez d’un doigt ou au S-Pen ; le trait suit votre mouvement.',
    'annotationHintUnderline': 'Dessinez sous le texte d’un doigt ou au S-Pen.',
...
'welcomePage1Title': 'Une vraie confidentialité',
  ...
  'de': {
    ...
    'drawingAllowsScrollHint':
        'Schloss offen: ein Finger zeichnet; nur zwei Finger zoomen oder verschieben (Seitenscroll bleibt gesperrt).',
    'lockPageNavigation': 'Zwei-Finger-Zoom sperren',
    ...
    'searchTextTool': 'Text suchen',
    'searchTextHint': 'Im Dokument suchen…',
    'searchTextNoResults': 'Keine Treffer',
    'searchTextSearching': 'Suche…',
    'searchTextMatchOf': '{current} von {total}',
    'searchTextPrevious': 'Zurück',
    'searchTextNext': 'Weiter',
    'unlockPageNavigation': 'Zwei-Finger-Zoom erlauben',
    ...
    'minimizeAnnotationTools': 'Weiterzeichnen (minimieren)',
    'readerFirstTip': 'Stift: Markieren/Unterstreichen/Pin wählen · Schloss: Zwei-Finger-Zoom · Unterschrift: unterschreiben.',
    'filterEbonyOn': 'Ébano-Filter',
    ...
    'annotationHintHighlight': 'Mit Finger oder S-Pen zeichnen; der Strich folgt Ihrer Bewegung.',
    'annotationHintUnderline': 'Unter dem Text mit Finger oder S-Pen zeichnen.',
...
'welcomePage1Title': 'Echte Privatsphäre',
  ...
  'zh': {
    ...
    'drawingAllowsScrollHint': '锁已打开：单指绘制；仅双指可缩放或移动页面（页面滚动仍锁定）。',
    'lockPageNavigation': '锁定双指缩放',
    ...
    'searchTextTool': '搜索文字',
    'searchTextHint': '在文档中搜索…',
    'searchTextNoResults': '无结果',
    'searchTextSearching': '正在搜索…',
    'searchTextMatchOf': '{current} / {total}',
    'searchTextPrevious': '上一个',
    'searchTextNext': '下一个',
    'unlockPageNavigation': '允许双指缩放',
    ...
    'minimizeAnnotationTools': '继续绘制（最小化）',
    'readerFirstTip': '笔：选择高亮/下划线/图钉 · 锁：双指缩放 · 签名图标：签名。',
    ...
    'annotationHintHighlight': '用单指或 S-Pen 绘制；笔迹跟随移动。',
    'annotationHintUnderline': '在文字下方用单指或 S-Pen 绘制。',
...
'welcomePage1Title': '真正的隐私',
  ...
  'ru': {
    ...
    'drawingAllowsScrollHint':
        'Замок открыт: один палец рисует; только два пальца зумят или двигают страницу (прокрутка страниц остаётся заблокированной).',
    'lockPageNavigation': 'Заблокировать масштаб двумя пальцами',
    ...
    'searchTextTool': 'Поиск текста',
    'searchTextHint': 'Искать в документе…',
    'searchTextNoResults': 'Нет результатов',
    'searchTextSearching': 'Поиск…',
    'searchTextMatchOf': '{current} из {total}',
    'searchTextPrevious': 'Назад',
    'searchTextNext': 'Далее',
    'unlockPageNavigation': 'Разрешить масштаб двумя пальцами',
    ...
    'minimizeAnnotationTools': 'Продолжить рисовать (свернуть)',
    'readerFirstTip': 'Карандаш: выделение/подчёркивание/булавка · Замок: масштаб двумя пальцами · Подпись: подписать.',
    ...
    'annotationHintHighlight': 'Рисуйте одним пальцем или S-Pen; штрих следует за движением.',
    'annotationHintUnderline': 'Рисуйте под текстом одним пальцем или S-Pen.',
