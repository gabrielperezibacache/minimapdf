import { Button, Dialog, Radio, Switch } from "@ds";

export function SettingsPanel({ open, onClose, theme, onTheme, lowGlare, onLowGlare }) {
  return (
    <Dialog open={open} title="Settings" onClose={onClose}>
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ color: "var(--color-text-primary)", fontWeight: 600, fontSize: "var(--text-sm)" }}>
            Ultra-low-glare mode
          </div>
