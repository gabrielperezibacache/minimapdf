...
|---------|---------|---------|---------------|
| `minimalpdf-1.0.0+16-release.aab` | App Bundle (Play) | 1.0.0 (code 16) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+16-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 16) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+15-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 15) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+14-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 14) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+13-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 13) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+12-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 12) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+11-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 11) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+10-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 10) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+9-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 9) | `apps.perezibacache.minimalpdf` |
| `minimalpdf-1.0.0+8-testing.apk` | APK (testing / instalación directa) | 1.0.0 (code 8) | `apps.perezibacache.minimalpdf` |
